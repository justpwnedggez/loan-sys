...
export default function MasterFilesDropdown({ auth }) {
        ...
        <div className="relative">
            ...
            {isOpen && (
                <div className="mt-4 ml-8 space-y-2 w-full">
                    <Link
                        href="#"
                        className="block w-64 px-4 py-2 text-gray-300 hover:bg-gray-600 hover:text-white border border-gray-700 rounded"
                    >
                        Loans
                    </Link>
                    <Link
